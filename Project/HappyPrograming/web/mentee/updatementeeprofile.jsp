        ...
        <div class="container">
            ...
            <form action="menteeprofile" method="post">
                ...
                <div style="display: flex">
                    <label>Gender:</label>
                    <c:choose>
                        <c:when test="${acc.gender == 1}">
                            <input style="margin-left: 40px" type="radio" id="male" name="gender" value="1" checked/>
                            <label for="male">Male</label>
                            <input style="margin-left: 40px" type="radio" id="female" name="gender" value="0" />
                            <label for="female">Female</label>
                            <input style="margin-left: 40px" type="radio" id="other" name="gender" value="2" />
                            <label for="female">Other</label>
                        </c:when>
                        <c:when test="${acc.gender == 0}">
                            <input style="margin-left: 40px" type="radio" id="male" name="gender" value="1" />
                            <label for="male">Male</label>
                            <input style="margin-left: 40px" type="radio" id="female" name="gender" value="0" checked/>
                            <label for="female">Female</label>
                            <input style="margin-left: 40px" type="radio" id="other" name="gender" value="2" />
                            <label for="female">Other</label>
                        </c:when>
                        <c:otherwise>
                            ...
                            <input style="margin-left: 40px" type="radio" id="female" name="gender" value="0" />
                            <label for="female">Female</label>
                            <input style="margin-left: 40px" type="radio" id="other" name="gender" value="2" checked/>
                            <label for="female">Other</label>
                        </c:otherwise>
                    </c:choose>
                </div>
