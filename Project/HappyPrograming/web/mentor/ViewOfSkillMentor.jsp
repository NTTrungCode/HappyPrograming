                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">						
                            <h4 class="modal-title">My Cv Mentor</h4>
                        </div>
                        <div class="modal-body">					
                            <div class="form-group">
                                <label for="id1">Avatar</label>  
                                <img src="${ma.ava}" alt="MyAvatar">
                            </div>
                            <div class="form-group">
                                <Label>Name:</Label>
                                <label>${ma.fullName}</label>                                  
                            </div>
                            <div class="form-group">
                                <Label>Job:</Label>
                                <label>${ma.job}</label>                                  
                            ...
                            <div class="form-group">
                                ...
                                <label>${ma.intro}</label>                                   
                            </div>
                            <div class="form-group">
                                <label>Achivement:</label>
                                <label>${ma.achivement}</label>                                 
                            </div>
                            <div class="form-group">
                                <label>Skill:</label>           
                                <div class="skill-option">
                                    <table>
                                        <c:forEach items = "${listSkill}" var = "o">
                                            <tr>
                                                <th>${o.name}</th>
                                                <th><a href="ListRating">Rating</a></th>
                                            </tr>
                                        </c:forEach>                                 
                                    </table>
