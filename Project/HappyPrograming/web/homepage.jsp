<%-- 
    Document   : homepage
    Created on : May 16, 2024, 11:09:19 PM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
        ...
        <a href='createCv'>Create CV of Mentor</a>
                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                ...
                                <p class="fs-5 text-white mb-4 pb-2">The best website for Online Learning. Website specializing in information technology and programming courses. </p>
                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                ...
                                <p class="fs-5 text-white mb-4 pb-2">Makes learning programming at home easier and more convenient. </p>
                                <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Read More</a>
                                <a href="" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Join Now</a>
                            </div>
                        </div>
                    ...
                    <div class="team-item bg-light">
                        ...
                        <div class="position-relative d-flex justify-content-center" style="margin-top: -23px;">
                            <div class="bg-light d-flex justify-content-center pt-2 px-1">
                                <a class="btn btn-sm-square btn-primary mx-1" href="">View Cv Mentor<i class="fab fa-facebook-f"></i></a>                              
                            </div>
                        </div>
