...
public class MentorDBContext extends DBContext<Mentor> {
    ...
    public void insertCvMentor1(String ava, String job, String intro, String achivement, int accId) throws SQLException {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        db.insertCvMentor1("a", "cá", "adwdw", "ád", 6);
        System.out.println(db.getIdOfNewMentor());
